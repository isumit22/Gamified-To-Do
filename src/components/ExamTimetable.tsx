      ...
      {viewMode === 'calendar' && (
        <div className="mb-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg sm:text-xl font-bold text-gray-800">Exam Calendar</h2>
            <button
          ...
          <div className="flex gap-2">
            {viewMode === 'list' && (
              <button
                ...
                title="View calendar"
                className="p-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-all active:scale-95 flex items-center gap-2"
              >
                <Calendar size={20} />
